...
const projects: Project[] = [
  ...
  {
    id: "la-unica-restaurant",
    title: "La-Unica (Restaurant)",
    subtitle: "Product Designer & Systems Engineer | Commissioned",
    bullets: [
    ...
    tags: ["Design", "Operations", "React", "Frontend"],
    documentationLabel: "Commissioned Project",
    statusLabel: "Commissioned",
  },
  {
    id: "real-estate-startup",
    title: "Real Estate Startup",
    subtitle: "Machine Learning Lead | Contract | Confidential",
    bullets: [
    ...
    tags: ["Machine Learning", "Real Estate", "Confidential"],
